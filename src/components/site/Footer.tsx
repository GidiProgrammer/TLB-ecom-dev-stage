...
export function Footer() {
  ...
  return (
    <footer className="mt-20 max-w-full border-t-4 border-gold bg-neutral-900 text-neutral-50">
      <div className="container-page grid min-w-0 gap-10 py-14 md:grid-cols-4">
            ...
            {(categories ?? []).map((c) => (
              <li key={c.slug} className="min-w-0">
                <Link
                  ...
                  className="flex min-h-11 min-w-0 items-center break-words hover:text-neutral-50"
                >
                  {c.name}
                </Link>
              </li>
        ...
        <div className="min-w-0">
          ...
          <ul className="mt-4 space-y-1 text-sm text-neutral-400">
            <li>
              <Link to="/about" className="flex min-h-11 min-w-0 items-center break-words hover:text-neutral-50">
                About us
              </Link>
            </li>
            <li>
              <Link to="/blog" className="flex min-h-11 min-w-0 items-center break-words hover:text-neutral-50">
                Knowledge hub
              </Link>
            </li>
            <li>
              <Link to="/quote" className="flex min-h-11 min-w-0 items-center break-words hover:text-neutral-50">
                Request a quote
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/contact" className="flex min-h-11 min-w-0 items-center break-words hover:text-neutral-50">
                Contact
              </Link>
            </li>
          </ul>
          ...
          <ul className="mt-4 space-y-1 text-sm text-neutral-400">
            ...
            <li>
              <a
                ...
                className="flex min-h-11 min-w-0 items-center gap-2 break-words hover:text-neutral-50"
              >
            ...
            <li>
              <a href={`mailto:${COMPANY.email}`} className="flex min-h-11 min-w-0 items-center gap-2 hover:text-neutral-50">
      ...
      <div className="border-t border-white/10">
        <div className="container-page flex min-w-0 flex-col gap-2 py-5 text-xs text-neutral-400 sm:flex-row sm:items-center sm:justify-between">
